...
from library.utils import list_nesting_remover, boundary_calculator
...
class HumanTracking:
    ...
    def TRK_update_poss_matrix(self, valid_points_list):
        ...
        poss_clus_list = list_nesting_remover(list(self.TRK_poss_clus_deque))
        ...
        for clus_valid_points in poss_clus_list:
            x, y, z = boundary_calculator(clus_valid_points, idx=range(3))
